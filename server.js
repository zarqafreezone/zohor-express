...
const CATEGORY_IMAGES = {
  ...
  'بوتيك وملابس': '/img/shops/boutique.jpg',
  'الأحذية': '/img/shops/shoes.jpg',
  'عطور واكسسوارات': '/img/shops/perfumes.jpg',
...
dbReady = loadDb().then(() => {
  ...
  db.shops.forEach((sh) => {
    ...
    else if (sh.category === 'بوتيك - ملابس - عطور - اكسسوارات') { sh.category = 'بوتيك وملابس'; renamed++; }
  });
